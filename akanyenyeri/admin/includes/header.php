...
<header class="admin-header">
    ...
    <div class="header-right">
        ...
        <div class="quick-actions">
            <a href="post-new.php" class="quick-action" title="Add New Post">
                <i class="fas fa-plus"></i>
                <span class="action-text">New Post</span>
            </a>

            <a href="analytics.php" class="quick-action" title="View Analytics">
                <i class="fas fa-chart-line"></i>
                <span class="action-text">Analytics</span>
            </a>

            <a href="../index.php" class="quick-action" title="View Site" target="_blank">
