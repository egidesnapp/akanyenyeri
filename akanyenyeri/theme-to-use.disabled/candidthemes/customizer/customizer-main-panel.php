<?php
     ...
     */
    $default = rectified_magazine_default_theme_options_values();

    /*
    * Theme Options Panel
    */
    $wp_customize->add_panel( 'rectified_magazine_panel', array(
     'priority' => 25,
     'capability' => 'edit_theme_options',
     'title' => __( 'Rectified Magazine Options', 'rectified-magazine' ),
    ) );
