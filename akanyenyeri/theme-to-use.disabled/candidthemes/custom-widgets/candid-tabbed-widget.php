<?php
/**
 * Rectified Magazine Post Tabbed Widget
 *
 * @since 1.0.0
 */
if (!class_exists('Rectified_Magazine_Tabbed_Post')) :
     ...
     * @since 1.0.0
     */
    class Rectified_Magazine_Tabbed_Post extends WP_Widget
    {
        private function defaults()
        {
            $defaults = array(
                'title' => esc_html__('Posts Tabbed', 'rectified-magazine'),
                'popular_title' => esc_html__('Popular', 'rectified-magazine'),
                'recent_title' => esc_html__('Latest', 'rectified-magazine'),
                'post-number' => 5,
            );
            return $defaults;
        }
        ...
        {
            $opts = array(
                'classname' => 'rectified-magazine-tabbed',
                'description' => esc_html__('Tabbed Widget for multiple content.', 'rectified-magazine'),
            );
            parent::__construct('rectified-magazine-tabbed', esc_html__('Rectified Magazine Tabbed', 'rectified-magazine'), $opts);
        }
                                            ...
                                            <div class="post-block-style">
                                                ...
                                                <div class="post-content">
                                                    ...
                                                    <h3 class="post-title">
                                                        ...
                                                        <div class="post-meta">
                                                            <?php rectified_magazine_posted_on(); ?>
                                                        </div>
...
public function form($instance)
{
    ...
    <p>
        <label
        for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Widget Title:', 'rectified-magazine'); ?></label>
    ...
    <p>
        <label
        for="<?php echo esc_attr($this->get_field_id('popular_title')); ?>"><?php esc_html_e('Popular Title:', 'rectified-magazine'); ?></label>
    ...
    <p>
        <label
        for="<?php echo esc_attr($this->get_field_id('recent_title')); ?>"><?php esc_html_e('Recent Title:', 'rectified-magazine'); ?></label>
