...
if (!function_exists('rectified_magazine_construct_main_navigation')) {
    /**
     * Add main navigation on header
     *
     * @since 1.0.0
     */
    function rectified_magazine_construct_main_navigation()
    {
        ...
        ?>
        <div class="rectified-magazine-menu-container <?php echo $sticky_header_class; ?>">
            <div class="container-inner clearfix">
                <nav id="site-navigation"
                     class="main-navigation" <?php rectified_magazine_do_microdata('navigation'); ?>>
                ...
                <?php
                global $rectified_magazine_theme_options;
                $rectified_weather_shortcode = wp_kses_post($rectified_magazine_theme_options['rectified-magazine-enable-weather']);
                if (!empty($rectified_weather_shortcode)):
                    ?>

                    <div class="header-weather">
                        <?php echo do_shortcode($rectified_weather_shortcode); ?>
                    </div>
                <?php
                endif; //$rectified_weather_shortcode
                ?>
...
add_action('rectified_magazine_main_navigation', 'rectified_magazine_construct_main_navigation', 10);